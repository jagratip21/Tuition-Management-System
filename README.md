...
Deploy the backend on Render using `render.yaml`. The Blueprint provisions PostgreSQL and configures these environment variables automatically:

- `DATABASE_URL` - injected from the managed PostgreSQL database
